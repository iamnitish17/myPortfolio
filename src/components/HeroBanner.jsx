            ...
            <Wrapper>
                ...
                >
                    <div className="flex items-center gap-[6px]">
                        ...
                        <div>iamnitish1109@gmail.com</div>
                    </div>
                ...
                >
                    <div className="font-light mb-4">
                        👋 Hi, I Am{" "}
                        <span className="font-semibold">Nitish Raj</span>
                    </div>
                    <div className="max-w-[510px]">
                        I create captivating and responsive user interfaces that seamlessly merge aesthetics with functionality. My commitment lies in crafting immersive web experiences.
                    </div>
                </motion.div>
                {/* INTRO END */}
